    ...
    return (
        <main>
            <section className='px-[30px] md:px-[3rem] lmd:p-[4rem] py-[4rem] w-full' id='about'>
                <div className="about flex items-center flex-col md:flex-row gap-8 md:gap-0">
                    <div className="abt_txt w-full md:w-[50%] flex flex-col gap-4">
                        <h3 className='text-accent font-semibold text-[20px]'>About us</h3>
                        ...
                        <Link href='' className='w-fit py-2 px-4 rounded-[30px] bg-light border-[1px] border-dark block'>
                            Contact us
                        </Link>
                    </div>
                    <div className="abt_img w-full md:w-[50%] flex flex-col items-center justify-center">
                        <Image className='w-[200px] h-[200px]' src={abt} alt='' />
            ...
            <section className='px-[30px] md:px-[3rem] lmd:px-[4rem] py-[4rem] w-full' id='service'>
                <div className="services">
                    ...
                    <div className="services_list grid md:grid-cols-2 gap-8">
                        {
                            services.map((serv) => (
                                <div key={serv.id} style={{ boxShadow: `20px 15px 0 ${serv.shadow}` }} className="service_item rounded-[30px] relative overflow-hidden">
                                    ...
                                    <div className="service_txt absolute h-fit w-full bottom-0 left-0 p-5 rounded-[20px] text-light">
                                        <h3 className='font-semibold text-[20px] mb-3'>{serv.title}</h3>
            ...
            <section className='px-[30px] md:px-[3rem] lmd:px-[4rem] py-[4rem] w-full' id='client'>
                <div className="client w-full bg-section rounded-[20px] p-5">
                    <div className="client_head mb-[2rem] text-center">
                        <h3 className='text-accent font-semibold text-[20px]'>Client process</h3>
                        <p>Our typical client journey involves</p>
                    </div>
                    <div className="client_info grid md:grid-cols-3 gap-8 md:gap-3">
                        {
                            client.map((data) => (
                                <div key={data.id} className="client_info">
                                    <div style={{background: data.shadow}} className="client_img flex items-center justify-center w-[35px] h-[35px] rounded-full text-light font-semibold text-[18px] mb-6">
                                        <h3>{data.id}</h3>
                                    </div>
                                    <div className="client_txt">
                                        <h3 className='font-semibold text-[20px] mb-3'>{data.title}</h3>
            ...
            <section className='px-[30px] md:px-[3rem] lmd:px-[4rem] py-[4rem] w-full' id='consultation'>
                <div className="spot flex items-center flex-col md:flex-row gap-10 md:gap-20">
                    <div className="spot_img rounded-[30px] overflow-hidden" style={{boxShadow: `20px 15px 0 rgba(219, 46, 152, 1)`}}>
                        <Image className='w-full md:w-[550px] h-[300px] object-cover' src={contact} alt='' />
                    </div>
                    <div className="spot_txt">
                        <h3 className='font-semibold text-[20px]'>Reserve your spot...</h3>
                        <h1 className='text-[35px] sm:text-[45px] font-bold'>Schedule a consultation call with us today.</h1>
                        <Link href='' className='w-fit py-2 px-4 rounded-[30px] bg-accent text-light border-[1px] border-dark block mt-6'>
            ...
            <section className='px-[30px] md:px-[3rem] py-[4rem] lmd:px-[4rem] w-full' id=''>
                <div className="motto">
                    <div className="motto_title">
                        <h1 className='text-[35px] sm:text-[45px] font-bold w-full md:w-[600px]'>"The best brands are the ones that tell a story"</h1>
                        <p>~Jeff Bezos</p>
                    </div>
                </div>
            </section>
            ...
            <section className='px-[30px] md:px-[3rem] py-[4rem] lmd:px-[4rem] w-full' id='contact'>
                <div className="contact">
                    <div className="contact_head text-center">
                        <h3 className='text-accent font-semibold text-[20px]'>Contact us</h3>
                    </div>
                    <div className="contact_form">
                        <h1 className='text-[40px] font-bold w-full md:w-[600px] mx-auto text-center text-slate-500'>
                        ...
                        <form action="" className='w-full md:w-[600px] mx-0 md:mx-auto mt-8'>
                            <div className="frm_inp w-full grid gap-5">
                                ...
                                <div className="inp_crl w-full">
                                    <textarea className='w-full h-[40px] border-b-2 outline-none px-2' placeholder='Tell us about your project'></textarea>
                                </div>
                            </div>
                            <div className="frm_btn">
                                <button className='w-fit py-2 px-4 rounded-[30px] bg-light border-[1px] border-dark block mt-8 ml-auto'>Send Message</button>
                            </div>
                        </form>
                    </div>
                </div>
